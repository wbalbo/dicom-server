...
{
    internal class MyBlobClientInitializer : IBlobClientInitializer
    {
        private readonly IBlobClientTestProvider _testProvider;
        private readonly ILogger<MyBlobClientInitializer> _logger;

        public MyBlobClientInitializer(IBlobClientTestProvider testProvider, ILogger<MyBlobClientInitializer> logger)
        {
