...
namespace Microsoft.Health.Dicom.SqlServer.Features.Schema.Model
{
    ...
    internal class VLatest
    {
        ...
        internal readonly static ReindexStoreTable ReindexStore = new ReindexStoreTable();
        ...
        internal class ReindexStoreTable : Table
        {
            internal ReindexStoreTable() : base("dbo.ReindexStore")
            {
            }
