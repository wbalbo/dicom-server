...
namespace Dicom.Serialization
{
    ...
    public class JsonDicomConverter : JsonConverter
    {
        ...
        private readonly static Encoding JsonTextEncoding = Encoding.UTF8;
        ...
        private static DicomItem CreateDicomItem(DicomTag tag, string vr, object data)
        {
            ...
            switch (vr)
            {
                ...
                case "IS":
                    ...
                    break;
                case "LO":
                    item = new DicomLongString(tag, JsonTextEncoding, (string[])data);
                    break;
                case "LT":
                    if (data is IByteBuffer dataBufferLT)
                    {
                        item = new DicomLongText(tag, JsonTextEncoding, dataBufferLT);
                    }
                    else
                    {
                        item = new DicomLongText(tag, JsonTextEncoding, data.AsStringArray().SingleOrEmpty());
                    }
                    break;
                case "OB":
                ...
                case "OV":
                    ...
                    break;
                case "PN":
                    item = new DicomPersonName(tag, JsonTextEncoding, (string[])data);
                    break;
                case "SH":
                    item = new DicomShortString(tag, JsonTextEncoding, (string[])data);
                    break;
                case "SL":
                ...
                case "ST":
                    ...
                    {
                        item = new DicomShortText(tag, JsonTextEncoding, dataBufferST);
                    }
                    else
                    {
                        item = new DicomShortText(tag, JsonTextEncoding, data.AsStringArray().FirstOrEmpty());
                    }
                    break;
                case "SV":
                ...
                case "UC":
                    ...
                    {
                        item = new DicomUnlimitedCharacters(tag, JsonTextEncoding, dataBufferUC);
                    }
                    else
                    {
                        item = new DicomUnlimitedCharacters(tag, JsonTextEncoding, data.AsStringArray().SingleOrDefault());
                    }
                    break;
                case "UI":
                ...
                case "UT":
                    ...
                    {
                        item = new DicomUnlimitedText(tag, JsonTextEncoding, dataBufferUT);
                    }
                    else
                    {
                        item = new DicomUnlimitedText(tag, JsonTextEncoding, data.AsStringArray().SingleOrEmpty());
                    }
                    break;
                case "UV":
