...
namespace Microsoft.Health.Dicom.Core.Features.Indexing
{
    ...
    public class InstanceReindexer : IInstanceReindexer
    {
        ...
        public async Task ReindexInstanceAsync(IReadOnlyList<ExtendedQueryTagStoreEntry> entries, VersionedInstanceIdentifier instanceId, CancellationToken cancellationToken)
        {
            DicomDataset dataset = await _metadataStore.GetInstanceMetadataAsync(instanceId, cancellationToken);
